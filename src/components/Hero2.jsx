...
const Hero = () => {
  return (
    <div className="flex gap-10 pt-10 mx1200 place-items-center h-[80vh]">
      ...
      <div className="image hidden md:flex lg:flex xl:flex max-w-[600px] relative flex-1 h-full flex place-items-center w-full">
        <motion.img
          ...
          src="main-pic-dark.png"
          alt="main-pic-dark.png"
        />
        <motion.img
          initial={{ opacity: 0, y: 300 }}
          transition={{
          ...
          animate={{ y: 0, opacity: 1 }}
          className="absolute bottom-[200px] left-[60px] z-40"
        ...
        <motion.img
          ...
          animate={{ y: 0, opacity: 1 }}
          className="absolute right-[10px] top-[40px] w-[200px]"
